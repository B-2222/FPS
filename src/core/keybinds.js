...
export const ACTIONS = [
  ...
  { id: 'crouch',    label: 'Crouch',            group: 'Movement', def: ['ControlLeft', null] },
  ...
  { id: 'slide',     label: 'Slide',             group: 'Movement', def: ['KeyC', null] },
  ...
  { id: 'use',       label: 'Use / Plant / Defuse', group: 'Combat', def: ['KeyF', null] },
  { id: 'gadget',    label: 'Throw Gadget',      group: 'Combat',   def: ['KeyG', null] },
  { id: 'ability',   label: 'Operator Ability',  group: 'Combat',   def: ['KeyZ', null] },
  { id: 'cameras',   label: 'Camera Feed',       group: 'Interface', def: ['KeyB', null] },
